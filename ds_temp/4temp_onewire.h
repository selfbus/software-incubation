...
// DHT
  ...
  extern int __idata __at (0xFE-0x2A) dht_humid;
	...
	#define OWDELAY_WRITE_B1		23
	#define OWDELAY_WRITE_B0		25
	#define OWDELAY_READ			  13
...
# endif
	...
	#define OWDELAY_WRITE_B1		260
	#define OWDELAY_WRITE_B0		275
	#define OWDELAY_READ			  140
  #define OWDELAY_DHT_RECEIVE 4600
  #define OWDELAY_DHT_INIT    63000

  inline void owdelay(unsigned int deltime)   // Warten, deltime = Anzahl Takte / 2 (Timer wird mit CCLK/2 betrieben)
