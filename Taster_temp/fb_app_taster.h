...
extern unsigned int __idata __at (0xFE-16) object_value[8];
extern unsigned char bitobject; // für die unteren 8 Bitobjekte

extern unsigned char sequence;
extern unsigned char timercnt[8],timerbase[8],timerstate[8];
